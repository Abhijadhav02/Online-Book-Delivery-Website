    ...
    <div class="main_box">
      ...
      <?php
        ...
        <div class="card-body">
          ...
          <a href="admin_pending_orders.php" class="btn btn-primary">Details</a>
          </div>
        </div>
      </div>
      <div class="card" style="width: 15rem">
      <?php
        ...
        <div class="card-body">
          ...
          <div class="buttons" style="display: flex;">
          <a href="admin_completed_orders.php" class="btn btn-primary">Details</a>
          </div>
        </div>
      </div>
      <div class="card" style="width: 15rem">
      ...
      <div class="card" style="width: 15rem">
        ...
        <div class="card-body">
          ...
          <a href="admins_details.php" class="btn btn-primary">Details</a>
        </div>
      </div>
      <div class="card" style="width: 15rem">
