...
if (isset($_POST['add_books'])) {
    ...
    $price = $_POST['price'];
    $stock = $_POST['stock']; // Added stock quantity
    ...
    if (empty($bname)) {
        ...
        $add_book = mysqli_query($conn, "INSERT INTO book_info(`name`, `title`, `price`, `stock`, `category`, `description`, `image`) VALUES('$bname','$btitle','$price','$stock','$category','$desc','$img')") or die('Query failed');
...
if (isset($_POST['update_product'])) {
    ...
    $update_stock = $_POST['update_stock']; // Added stock quantity

    mysqli_query($conn, "UPDATE `book_info` SET name = '$update_name', title='$update_title', description ='$update_description', price = '$update_price', stock = '$update_stock', category='$update_category' WHERE bid = '$update_p_id'") or die('query failed');
...
<body>
    ...
    <div class="container_box">
        <form action="" method="POST" enctype="multipart/form-data">
            <h3>Add Books To <a href="index.php"><span>Bookflix</span><span></span></a></h3>
            ...
            <input type="number" min="0" name="stock" class="text_field" placeholder="enter stock quantity">
    ...
    <section class="edit-product-form">
        <!-- Your existing code for edit-product-form section remains the same -->
    </section>

    <section class="show-products">
        <!-- Your existing code for show-products section remains the same -->
    </section>
