...
<body>
   ...
   <section class="placed-orders">
      ...
      <table>
         ...
         <?php
         $select_orders = mysqli_query($conn, "SELECT * FROM confirm_order WHERE payment_status='pending'") or die('query failed');
         ...
         <?php
            ...
            echo '<tr><td colspan="11" class="empty">No pending orders!</td></tr>';
         }
         ?>
      </table>
